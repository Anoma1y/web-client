  ...
  <div className={'auth'}>
    ...
    <div className="auth-header">
      ...
      <div className="auth-additional">
        ...
        <div className="header-beta-info">
          <span>Get the IOS / Android APP</span>
        </div>
      </div>
    </div>
    ...
    <div className={'container'}>
      ...
      <Switch>
        ...
        <Route exact path={`${props.match.url}/`} component={Signin} />
