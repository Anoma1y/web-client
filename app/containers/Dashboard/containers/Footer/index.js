      ...
      <div className={'footer-container'}>
        ...
        <div className={'footer-pay-systems'}>
          <div className={'footer-pay-systems_item'}>
            <img src={'/static/images/ssl-min.png'} alt="SSL logo" />
          </div>

          <div className={'footer-pay-systems_item'}>
            <img src={'/static/images/visa-footer-min.png'} alt="Visa logo" />
          </div>

          <div className={'footer-pay-systems_item'}>
            <img src={'/static/images/mc-footer-min.png'} alt="MasterCard logo" />
          </div>
        </div>
